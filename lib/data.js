...
class Data {
  constructor (localConfig = {}) {
    ...
    this.createTokenData = this.createTokenData.bind(this)
    this.writeCIDToOpReturn = this.writeCIDToOpReturn.bind(this)
  }
  ...
  async createTokenData (inObj) {
    try {
      ...
      console.error('Error in slp-mutable-data/data.js createTokenData()')
      throw err
    }
  }
  ...
  async writeJsonToP2wdb (inObj) {
    try {
      ...
      console.log('finished initializing wallet. Posting entry.')
      ...
      console.error('Error in slp-mutable-data/data.js writeJsonToP2wdb()')
      throw err
    }
  }
  ...
  async pinJson (inObj) {
    try {
      ...
      console.error('Error in slp-mutable-data/data.js pinJson()')
      throw err
    }
  }
  ...
  async writeCIDToOpReturn (cid, wif) {
    try {
      ...
      console.error('Error in writeCIDToOpReturn: ', err)
      throw err
    }
  }
